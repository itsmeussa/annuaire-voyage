...
import { filterAgencies } from "@/lib/agencies";
...
export default function HiddenAgenciesPage() {
  ...
  useEffect(() => {
    const init = async () => {
      // setAgencies(getAllMoroccanAgencies()); // OLD
      // Fetch ALL agencies, not just MA, so we can see newly added ones
      const { agencies: allAgencies } = await filterAgencies("", "", "", 0, "", "all", 1, 10000); // NEW
  ...
  const SortButton = ({ field, label }: { field: SortField; label: string }) => (
    <button
      ...
      className={`flex items-center gap-1 text-sm font-medium ${sortField === field ? "text-emerald-600" : "text-slate-600"
        }`}
    >
      {label}
              ...
              <div className="grid grid-cols-3 gap-2">
                {USER_PROFILES.map((profile) => (
                  <button
                    ...
                    className={`py-3 px-4 rounded-lg font-medium transition-all ${selectedProfile === profile.name
      ...
      <div className="bg-slate-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold mb-2">Admin Dashboard - All Agencies</h1>
          ...
          <div className="bg-white rounded-xl p-4 mb-6 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-2 mt-4">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${filter === "visible"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${filter === "hidden"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${assignedFilter === "all"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${assignedFilter === "Aya"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${assignedFilter === "Zaki"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${assignedFilter === "Ussa"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${contactedFilter === "all"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors flex items-center gap-1 ${contactedFilter === "contacted"
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${contactedFilter === "not-contacted"
              ...
              <select
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${websiteFilter !== "all"
              ...
              <select
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${phoneFilter !== "all"
              ...
              <select
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${whatsappFilter !== "all"
              ...
              <select
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors border ${triedFilter !== "all"
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <button
                            ...
                            className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all cursor-pointer hover:scale-110 ${contactedAgencies[agency.id]?.contacted
                        ...
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${assignedTo === "Aya"
                            ...
                            <a
                              href={`https://wa.me/${formatPhoneForWhatsApp(agency.phone)}?text=${encodeURIComponent(
                                currentUser === "Ussa"
                                  ...
                                  : `Bonjour, je suis ${personName} de "Annuaire Voyage". Est-ce que c'est bien le numéro de ${agency.title} ?`
                              )}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-1 px-3 py-1.5 bg-green-50 text-green-700 hover:bg-green-100 rounded-lg text-sm transition-colors"
                            >
                        ...
                        <td className="px-4 py-3">
                          <button
                            ...
                            className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-all cursor-pointer hover:scale-110 ${triedAgencies[agency.id]?.tried
                              ? `${triedByProfile?.bgColor || 'bg-amber-500'} ${triedByProfile?.borderColor || 'border-amber-500'} text-white`
                              : `border-slate-300 hover:border-amber-500 text-amber-500`
                              }`}
                            title={triedAgencies[agency.id]?.tried
                              ? `Marqué comme essayé par ${triedAgencies[agency.id]?.triedBy} le ${new Date(triedAgencies[agency.id]?.triedAt).toLocaleDateString()}`
                              : "Marquer comme essayé (injoignable/pas de WhatsApp)"
                            }
                          >
